...
#
# Generated by export_simulation on Mon Jan 13 17:32:24 IST 2020
#
################################################################################
...
'-reset_run' switch to the './polar_2.sh' script.

./polar_2.sh -reset_run
...
./polar_2.sh -noclean_files

For more information on the script, please type './polar_2.sh -help'.
