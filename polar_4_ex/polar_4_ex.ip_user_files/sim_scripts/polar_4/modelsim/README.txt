...
#
# Generated by export_simulation on Mon Mar 09 11:20:57 IST 2020
#
################################################################################
...
'-reset_run' switch to the './polar_4.sh' script.

./polar_4.sh -reset_run
...
./polar_4.sh -noclean_files

For more information on the script, please type './polar_4.sh -help'.
