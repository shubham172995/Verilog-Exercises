...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXIS:SLOT_10_AXIS:SLOT_11_AXIS:SLOT_1_AXIS:SLOT_2_AXIS:SLOT_3_AXIS:SLOT_4_AXIS:SLOT_5_AXIS:SLOT_6_AXIS:SLOT_7_AXIS:SLOT_8_AXIS:SLOT_9_AXIS} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_9_AXIS_TDATA_WIDTH {32} \
...
connect_bd_intf_net -intf_net Conn11 [get_bd_intf_ports SLOT_11_AXIS] [get_bd_intf_pins g_inst/slot_11_axis]
  ...
  connect_bd_net -net net_slot_10_axis_tdata [get_bd_pins g_inst/m_slot_10_axis_tdata] [get_bd_pins ila_lib/probe42]
  connect_bd_net -net net_slot_10_axis_tlast [get_bd_pins g_inst/m_slot_10_axis_tlast] [get_bd_pins ila_lib/probe45]
  connect_bd_net -net net_slot_10_axis_tready [get_bd_pins g_inst/m_slot_10_axis_tready] [get_bd_pins ila_lib/probe44]
  connect_bd_net -net net_slot_10_axis_tvalid [get_bd_pins g_inst/m_slot_10_axis_tvalid] [get_bd_pins ila_lib/probe43]
  connect_bd_net -net net_slot_11_axis_tdata [get_bd_pins g_inst/m_slot_11_axis_tdata] [get_bd_pins ila_lib/probe46]
  connect_bd_net -net net_slot_11_axis_tlast [get_bd_pins g_inst/m_slot_11_axis_tlast] [get_bd_pins ila_lib/probe49]
  connect_bd_net -net net_slot_11_axis_tready [get_bd_pins g_inst/m_slot_11_axis_tready] [get_bd_pins ila_lib/probe48]
  connect_bd_net -net net_slot_11_axis_tvalid [get_bd_pins g_inst/m_slot_11_axis_tvalid] [get_bd_pins ila_lib/probe47]
  ...
  connect_bd_net -net net_slot_7_axis_tlast [get_bd_pins g_inst/m_slot_7_axis_tlast] [get_bd_pins ila_lib/probe33]
  connect_bd_net -net net_slot_7_axis_tready [get_bd_pins g_inst/m_slot_7_axis_tready] [get_bd_pins ila_lib/probe32]
  connect_bd_net -net net_slot_7_axis_tvalid [get_bd_pins g_inst/m_slot_7_axis_tvalid] [get_bd_pins ila_lib/probe31]
  connect_bd_net -net net_slot_8_axis_tdata [get_bd_pins g_inst/m_slot_8_axis_tdata] [get_bd_pins ila_lib/probe34]
  connect_bd_net -net net_slot_8_axis_tlast [get_bd_pins g_inst/m_slot_8_axis_tlast] [get_bd_pins ila_lib/probe37]
  connect_bd_net -net net_slot_8_axis_tready [get_bd_pins g_inst/m_slot_8_axis_tready] [get_bd_pins ila_lib/probe36]
  connect_bd_net -net net_slot_8_axis_tvalid [get_bd_pins g_inst/m_slot_8_axis_tvalid] [get_bd_pins ila_lib/probe35]
  connect_bd_net -net net_slot_9_axis_tdata [get_bd_pins g_inst/m_slot_9_axis_tdata] [get_bd_pins ila_lib/probe38]
  connect_bd_net -net net_slot_9_axis_tlast [get_bd_pins g_inst/m_slot_9_axis_tlast] [get_bd_pins ila_lib/probe41]
  connect_bd_net -net net_slot_9_axis_tready [get_bd_pins g_inst/m_slot_9_axis_tready] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_9_axis_tvalid [get_bd_pins g_inst/m_slot_9_axis_tvalid] [get_bd_pins ila_lib/probe39]
