...
proc create_root_design { parentCell } {
  ...
  # Create instance: datag_0, and set properties
  set datag_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:datag:1.0 datag_0 ]

  # Create instance: llr_0, and set properties
  set llr_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:llr:1.0 llr_0 ]
  ...
  # Create instance: polar_1, and set properties
  set polar_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:polar:1.0 polar_1 ]
  ...
  connect_bd_intf_net -intf_net datag_0_control_V [get_bd_intf_pins datag_0/control_V] [get_bd_intf_pins polar_0/S_AXIS_CTRL]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_control_V] [get_bd_intf_pins polar_0/S_AXIS_CTRL] [get_bd_intf_pins system_ila_0/SLOT_9_AXIS]
  connect_bd_intf_net -intf_net datag_0_din [get_bd_intf_pins datag_0/din] [get_bd_intf_pins polar_0/S_AXIS_DIN]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_din] [get_bd_intf_pins polar_0/S_AXIS_DIN] [get_bd_intf_pins system_ila_0/SLOT_8_AXIS]
  connect_bd_intf_net -intf_net datag_0_din_words [get_bd_intf_pins datag_0/din_words] [get_bd_intf_pins polar_0/S_AXIS_DIN_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_din_words] [get_bd_intf_pins polar_0/S_AXIS_DIN_WORDS] [get_bd_intf_pins system_ila_0/SLOT_10_AXIS]
  connect_bd_intf_net -intf_net datag_0_dout_words [get_bd_intf_pins datag_0/dout_words] [get_bd_intf_pins polar_0/S_AXIS_DOUT_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_dout_words] [get_bd_intf_pins polar_0/S_AXIS_DOUT_WORDS] [get_bd_intf_pins system_ila_0/SLOT_11_AXIS]
  connect_bd_intf_net -intf_net llr_0_control_V [get_bd_intf_pins llr_0/control_V] [get_bd_intf_pins polar_1/S_AXIS_CTRL]
connect_bd_intf_net -intf_net [get_bd_intf_nets llr_0_control_V] [get_bd_intf_pins polar_1/S_AXIS_CTRL] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  connect_bd_intf_net -intf_net llr_0_din [get_bd_intf_pins llr_0/din] [get_bd_intf_pins polar_1/S_AXIS_DIN]
connect_bd_intf_net -intf_net [get_bd_intf_nets llr_0_din] [get_bd_intf_pins polar_1/S_AXIS_DIN] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  connect_bd_intf_net -intf_net llr_0_din_words [get_bd_intf_pins llr_0/din_words] [get_bd_intf_pins polar_1/S_AXIS_DIN_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets llr_0_din_words] [get_bd_intf_pins polar_1/S_AXIS_DIN_WORDS] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net llr_0_dout_words [get_bd_intf_pins llr_0/dout_words] [get_bd_intf_pins polar_1/S_AXIS_DOUT_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets llr_0_dout_words] [get_bd_intf_pins polar_1/S_AXIS_DOUT_WORDS] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
  connect_bd_intf_net -intf_net polar_0_M_AXIS_DOUT [get_bd_intf_pins llr_0/dt] [get_bd_intf_pins polar_0/M_AXIS_DOUT]
connect_bd_intf_net -intf_net [get_bd_intf_nets polar_0_M_AXIS_DOUT] [get_bd_intf_pins polar_0/M_AXIS_DOUT] [get_bd_intf_pins system_ila_0/SLOT_6_AXIS]
connect_bd_intf_net -intf_net polar_0_M_AXIS_STATUS [get_bd_intf_pins polar_0/M_AXIS_STATUS] [get_bd_intf_pins system_ila_0/SLOT_7_AXIS]
connect_bd_intf_net -intf_net polar_1_M_AXIS_DOUT [get_bd_intf_pins polar_1/M_AXIS_DOUT] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net polar_1_M_AXIS_STATUS [get_bd_intf_pins polar_1/M_AXIS_STATUS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins polar_1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net polar_1_interrupt [get_bd_pins polar_1/interrupt] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins datag_0/ap_rst_n] [get_bd_pins llr_0/ap_rst_n] [get_bd_pins polar_0/reset_n] [get_bd_pins polar_1/reset_n] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins datag_0/ap_start] [get_bd_pins llr_0/ap_start] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins polar_1/m_axis_dout_tready] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins datag_0/ap_clk] [get_bd_pins llr_0/ap_clk] [get_bd_pins polar_0/core_clk] [get_bd_pins polar_1/core_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00040000 -offset 0xA0040000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs polar_1/S_AXI/PARAMS] SEG_polar_1_PARAMS
