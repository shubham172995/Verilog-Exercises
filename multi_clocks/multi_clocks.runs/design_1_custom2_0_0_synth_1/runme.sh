...
HD_PWD='/home/shubham/Vivado_Exercises/multi_clocks/multi_clocks.runs/design_1_custom2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_custom2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_custom2_0_0.tcl
