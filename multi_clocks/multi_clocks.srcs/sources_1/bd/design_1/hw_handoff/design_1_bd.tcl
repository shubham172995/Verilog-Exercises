...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins custom2_0/clock2] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net custom2_0_out_counter1 [get_bd_pins custom2_0/out_counter1] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net custom2_0_out_counter2 [get_bd_pins custom2_0/out_counter2] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins custom2_0/reset] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins custom2_0/enable] [get_bd_pins system_ila_0/probe2] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
