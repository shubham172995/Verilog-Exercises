...
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_control_V] [get_bd_intf_pins polar_0/S_AXIS_CTRL] [get_bd_intf_pins system_ila_0/SLOT_6_AXIS]
  connect_bd_intf_net -intf_net datag_0_din_V_V [get_bd_intf_pins datag_0/din] [get_bd_intf_pins polar_0/S_AXIS_DIN]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_din_V_V] [get_bd_intf_pins polar_0/S_AXIS_DIN] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  connect_bd_intf_net -intf_net datag_0_din_words_V_V [get_bd_intf_pins datag_0/din_words] [get_bd_intf_pins polar_0/S_AXIS_DIN_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_din_words_V_V] [get_bd_intf_pins polar_0/S_AXIS_DIN_WORDS] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net datag_0_dout_words_V_V [get_bd_intf_pins datag_0/dout_words] [get_bd_intf_pins polar_0/S_AXIS_DOUT_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets datag_0_dout_words_V_V] [get_bd_intf_pins polar_0/S_AXIS_DOUT_WORDS] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins datag_0/ap_rst_n] [get_bd_pins polar_0/reset_n] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins datag_0/ap_start] [get_bd_pins vio_0/probe_out0]
