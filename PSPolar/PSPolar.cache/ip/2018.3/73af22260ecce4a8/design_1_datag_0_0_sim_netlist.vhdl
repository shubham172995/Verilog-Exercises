...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag is
  ...
  signal i_1_fu_100_p2 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal i_1_reg_115 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal i_1_reg_1150 : STD_LOGIC;
  signal i_reg_83 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal p_0_in0 : STD_LOGIC;
  signal \tmp_3_reg_120[0]_i_1_n_2\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of din_V_V_1_sel_rd_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \din_V_V_1_state[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \din_V_V_TDATA[0]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \din_V_V_TDATA[2]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \i_1_reg_115[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \i_1_reg_115[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \tmp_3_reg_120[0]_i_1\ : label is "soft_lutpair2";
begin
  ap_done <= \^ap_ready\;
  ap_ready <= \^ap_ready\;
...
\din_V_V_1_state[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF4F"
    )
        port map (
...
\din_words_V_V_1_state[1]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\din_words_V_V_1_state[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF2F00FFFF"
    )
        port map (
...
\i_1_reg_115[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\i_1_reg_115[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\i_1_reg_115_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => i_1_reg_1150,
      D => i_1_fu_100_p2(0),
...
\i_1_reg_115_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => i_1_reg_1150,
      D => i_1_fu_100_p2(1),
...
\i_reg_83[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\i_reg_83[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\i_reg_83_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_NS_fsm1,
      D => i_1_reg_115(0),
...
\i_reg_83_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => ap_NS_fsm1,
      D => i_1_reg_115(1),
...
\tmp_3_reg_120[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3F10"
    )
        port map (
...
\tmp_3_reg_120_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
