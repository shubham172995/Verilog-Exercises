...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag is
  ...
  attribute ap_ST_fsm_state1 of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag : entity is "5'b00001";
  attribute ap_ST_fsm_state2 : string;
  attribute ap_ST_fsm_state2 of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag : entity is "5'b00010";
  attribute ap_ST_fsm_state3 : string;
  attribute ap_ST_fsm_state3 of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag : entity is "5'b00100";
  attribute ap_ST_fsm_state4 : string;
  attribute ap_ST_fsm_state4 of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag : entity is "5'b01000";
  attribute ap_ST_fsm_state5 : string;
  attribute ap_ST_fsm_state5 of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag : entity is "5'b10000";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag is
  ...
  signal i_1_fu_112_p2 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal i_1_reg_131 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal i_1_reg_1310 : STD_LOGIC;
  signal i_reg_95 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal p_0_in0 : STD_LOGIC;
  signal start_read_reg_124 : STD_LOGIC;
  signal \start_read_reg_124[0]_i_1_n_2\ : STD_LOGIC;
  signal \tmp_4_reg_136[0]_i_1_n_2\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of din_V_V_1_sel_rd_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \din_V_V_1_state[1]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \din_V_V_TDATA[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \din_V_V_TDATA[2]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \i_1_reg_131[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \i_1_reg_131[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of start_ap_ack_INST_0 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \start_read_reg_124[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \tmp_4_reg_136[0]_i_1\ : label is "soft_lutpair2";
begin
  ap_done <= \^ap_ready\;
  ap_ready <= \^ap_ready\;
...
\ap_CS_fsm[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => start_read_reg_124,
      I4 => ap_CS_fsm_state2,
      O => ap_NS_fsm(1)
    );
\ap_CS_fsm[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEFFEEEEEFFFEEEE"
    )
        port map (
      I0 => ap_NS_fsm1,
      I1 => ap_NS_fsm115_out,
...
\din_V_V_1_payload_A[61]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
din_V_V_1_sel_wr_i_1: unisim.vcomponents.LUT6
    generic map(
...
\din_V_V_1_state[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\dout_words_V_V_1_state[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF2F00FFFF"
    )
        port map (
...
\i_reg_95[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => ap_CS_fsm_state2,
      I1 => start_read_reg_124,
      O => ap_NS_fsm115_out
    );
\i_reg_95[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\start_read_reg_124[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      ...
      I2 => ap_start,
      I3 => start_ap_vld,
      I4 => start_read_reg_124,
      O => \start_read_reg_124[0]_i_1_n_2\
    );
\start_read_reg_124_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
      D => \start_read_reg_124[0]_i_1_n_2\,
      Q => start_read_reg_124,
      R => '0'
    );
\tmp_4_reg_136[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3F10"
    )
        port map (
      ...
      I2 => i_1_reg_1310,
      I3 => p_0_in0,
      O => \tmp_4_reg_136[0]_i_1_n_2\
    );
\tmp_4_reg_136_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
      D => \tmp_4_reg_136[0]_i_1_n_2\,
      Q => p_0_in0,
      R => '0'
    );
end STRUCTURE;
