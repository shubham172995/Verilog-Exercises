...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_datag is
  ...
  signal \din_V_V_1_state_reg_n_2_[1]\ : STD_LOGIC;
  ...
  signal i_1_fu_97_p2 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal i_1_reg_106 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal i_1_reg_1060 : STD_LOGIC;
  signal i_reg_80 : STD_LOGIC;
  signal \i_reg_80_reg_n_2_[0]\ : STD_LOGIC;
  signal \i_reg_80_reg_n_2_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \i_1_reg_106[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \i_1_reg_106[1]_i_1\ : label is "soft_lutpair2";
begin
  ap_done <= \^ap_ready\;
  ap_ready <= \^ap_ready\;
...
\i_1_reg_106[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\i_1_reg_106[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\i_1_reg_106_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => i_1_reg_1060,
      D => i_1_fu_97_p2(0),
...
\i_1_reg_106_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => i_1_reg_1060,
      D => i_1_fu_97_p2(1),
...
\i_reg_80[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\i_reg_80[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
