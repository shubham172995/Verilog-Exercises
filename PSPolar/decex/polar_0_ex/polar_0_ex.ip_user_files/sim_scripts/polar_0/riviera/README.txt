...
#
# Generated by export_simulation on Sat Feb 22 17:23:51 IST 2020
#
################################################################################
...
'-reset_run' switch to the './polar_0.sh' script.

./polar_0.sh -reset_run
...
./polar_0.sh -noclean_files

For more information on the script, please type './polar_0.sh -help'.
