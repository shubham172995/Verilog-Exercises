...
HD_PWD='/home/shubham/Vivado Exercises/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JKMaster.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JKMaster.tcl -notrace
