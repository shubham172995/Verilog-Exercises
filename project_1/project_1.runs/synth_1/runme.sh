...
HD_PWD='/home/shubham/Vivado Exercises/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JKMaster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JKMaster.tcl
