...
HD_PWD='/home/shubham/Vivado_Exercises/edt_zcu102/edt_zcu102.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log edt_zcu102_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source edt_zcu102_wrapper.tcl -notrace
