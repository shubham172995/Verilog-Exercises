...
HD_PWD='/home/shubham/Vivado_Exercises/edt_zcu102/edt_zcu102.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edt_zcu102_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edt_zcu102_wrapper.tcl
