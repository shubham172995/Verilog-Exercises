...
#
# Generated by export_simulation on Mon Jan 13 11:23:53 IST 2020
#
################################################################################
...
'-reset_run' switch to the './polar_1.sh' script.

./polar_1.sh -reset_run
...
./polar_1.sh -noclean_files

For more information on the script, please type './polar_1.sh -help'.
