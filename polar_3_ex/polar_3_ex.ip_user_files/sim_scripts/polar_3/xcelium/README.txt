...
#
# Generated by export_simulation on Thu Jan 30 15:12:30 IST 2020
#
################################################################################
...
'-reset_run' switch to the './polar_3.sh' script.

./polar_3.sh -reset_run
...
./polar_3.sh -noclean_files

For more information on the script, please type './polar_3.sh -help'.
