...
void XData_source_top_Set_enc_keep_V(XData_source_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XData_source_top_WriteReg(InstancePtr->Cntrl_BaseAddress, XDATA_SOURCE_TOP_CNTRL_ADDR_ENC_KEEP_V_DATA, Data);
}

u32 XData_source_top_Get_enc_keep_V(XData_source_top *InstancePtr) {
    u32 Data;
