...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module mod_and_chan_4x_QBew_rom (
...
initial begin
    $readmemh("./mod_and_chan_4x_QBew_rom.dat", ram0);
    $readmemh("./mod_and_chan_4x_QBew_rom.dat", ram1);
end
...
mod_and_chan_4x_QBew_rom mod_and_chan_4x_QBew_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
