...
(* CORE_GENERATION_INFO="stats_top,hls_ip_2018_1_0,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2L-e,HLS_INPUT_CLOCK=2.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.152500,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=16,HLS_SYN_DSP=0,HLS_SYN_FF=3700,HLS_SYN_LUT=3610}" *)
...
reg   [31:0] src_inc_parity_V_rea_reg_521;
reg   [31:0] num_blocks_V_read_reg_526;
reg   [127:0] mask_V_read_reg_532;
reg   [31:0] n_V_read_reg_537;
reg   [31:0] k_V_read_reg_542;
...
wire   [31:0] block_cnt_int_V_fu_354_p2;
...
reg   [0:0] tmp_1_reg_566_pp0_iter6_reg;
wire   [32:0] r_V_fu_369_p2;
reg   [32:0] r_V_reg_570;
wire   [31:0] i_V_fu_375_p2;
reg   [31:0] i_V_reg_575;
reg    ap_enable_reg_pp0_iter0;
wire   [127:0] src_bits_V_fu_400_p2;
reg   [127:0] src_bits_V_reg_580;
wire   [127:0] hard_bits_V_fu_406_p2;
reg   [127:0] hard_bits_V_reg_586;
wire   [127:0] error_bits_V_fu_412_p2;
reg   [127:0] error_bits_V_reg_591;
wire   [31:0] err_cnt_V_fu_422_p2;
reg    ap_enable_reg_pp0_iter7;
wire   [31:0] rerr_cnt_V_fu_432_p2;
wire   [31:0] raw_berr_int_V_fu_443_p2;
reg   [31:0] raw_berr_int_V_reg_609;
wire    ap_CS_fsm_state13;
wire   [0:0] tmp_9_fu_438_p2;
wire   [31:0] cor_berr_int_V_fu_449_p2;
reg   [31:0] cor_berr_int_V_reg_614;
wire   [31:0] p_0243_0_s_fu_467_p3;
reg   [31:0] p_0243_0_s_reg_619;
wire   [31:0] t_V_2_fu_487_p3;
reg   [31:0] t_V_2_reg_624;
wire   [31:0] j_V_1_fu_495_p2;
reg    ap_block_state15;
wire   [31:0] iter_cnt_int_V_fu_515_p2;
...
wire   [32:0] lhs_V_cast_fu_365_p1;
wire   [0:0] tmp_8_fu_389_p2;
wire   [127:0] r_V_4_fu_393_p3;
wire   [31:0] err_cnt_V_trunc_ext_fu_418_p1;
wire   [31:0] rerr_cnt_V_trunc_ext_fu_428_p1;
wire   [0:0] tmp_2_fu_455_p2;
wire   [31:0] cor_blerr_int_V_fu_461_p2;
wire   [0:0] tmp_3_fu_475_p2;
wire   [31:0] raw_blerr_int_V_fu_481_p2;
wire   [5:0] p_Result_s_fu_501_p4;
wire   [31:0] p_Result_2_fu_511_p1;
reg   [8:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond_fu_349_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((tmp_s_reg_553 == 1'd0) & (src_data_V_V_0_vld_out == 1'b0)) & (1'b1 == ap_CS_fsm_state15))) begin
        j_reg_314 <= j_V_1_fu_495_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((fe_status_V_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state16))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_1_reg_566_pp0_iter6_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter7 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_9_fu_438_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state13))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_1_reg_566 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_1_fu_360_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_1_fu_360_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_fu_349_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter6 == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b0) & (ap_enable_reg_pp0_iter4 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b0))) begin
        ap_idle_pp0 = 1'b1;
    end else begin
        ap_idle_pp0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state14) | ((tmp_1_reg_566 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((error_data_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state14)) | ((tmp_1_reg_566 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((~((tmp_s_reg_553 == 1'd0) & (src_data_V_V_0_vld_out == 1'b0)) & (tmp_s_reg_553 == 1'd0) & (1'b1 == ap_CS_fsm_state15)) | ((tmp_1_reg_566 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((tmp_s_reg_553 == 1'd0) & (1'b1 == ap_CS_fsm_state15)) | ((tmp_1_reg_566 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((tmp_1_fu_360_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((ap_enable_reg_pp0_iter6 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter7 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter6 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter7 == 1'b1)) | ((tmp_1_fu_360_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
        ...
        ap_ST_fsm_state14 : begin
            if (((error_data_V_data_V_0_vld_out == 1'b1) & (1'b1 == ap_CS_fsm_state14))) begin
        ...
        ap_ST_fsm_state15 : begin
            if ((~((tmp_s_reg_553 == 1'd0) & (src_data_V_V_0_vld_out == 1'b0)) & (1'b1 == ap_CS_fsm_state15))) begin
                ap_NS_fsm = ap_ST_fsm_state13;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state15;
            end
...
always @ (*) begin
    ap_block_state15 = ((tmp_s_reg_553 == 1'd0) & (src_data_V_V_0_vld_out == 1'b0));
end

assign ap_block_state4_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = (((tmp_1_reg_566 == 1'd1) & (error_data_V_data_V_0_vld_out == 1'b0)) | ((tmp_1_reg_566 == 1'd1) & (src_data_V_V_0_vld_out == 1'b0)) | ((tmp_1_reg_566 == 1'd1) & (hard_data_V_data_V_0_vld_out == 1'b0)));
end
...
assign block_cnt_int_V_fu_354_p2 = (t_V_3_reg_202 + 32'd1);

assign cor_berr_int_V_fu_449_p2 = (p_3_reg_278 + p_1_reg_239);

assign cor_blerr_int_V_fu_461_p2 = (t_V_reg_252 + 32'd1);

assign err_cnt_V_fu_422_p2 = (err_cnt_V_trunc_ext_fu_418_p1 + p_3_reg_278);

assign err_cnt_V_trunc_ext_fu_418_p1 = grp_num_diff_fu_325_ap_return;

assign error_bits_V_fu_412_p2 = (r_V_4_fu_393_p3 & error_data_V_data_V_0_data_out);
...
assign exitcond_fu_349_p2 = ((t_V_3_reg_202 == num_blocks_V_read_reg_526) ? 1'b1 : 1'b0);
...
assign hard_bits_V_fu_406_p2 = (r_V_4_fu_393_p3 & hard_data_V_data_V_0_data_out);
...
assign i_V_fu_375_p2 = (ap_phi_mux_j_V_phi_fu_306_p4 + 32'd128);

assign iter_cnt_int_V_fu_515_p2 = (p_Result_2_fu_511_p1 + p_2_reg_265);

assign j_V_1_fu_495_p2 = (j_reg_314 + 32'd128);

assign lhs_V_cast_fu_365_p1 = ap_phi_mux_j_V_phi_fu_306_p4;

assign p_0243_0_s_fu_467_p3 = ((tmp_2_fu_455_p2[0:0] === 1'b1) ? t_V_reg_252 : cor_blerr_int_V_fu_461_p2);

assign p_Result_2_fu_511_p1 = p_Result_s_fu_501_p4;

assign p_Result_s_fu_501_p4 = {{fe_status_V_V_0_data_out[23:18]}};

assign r_V_4_fu_393_p3 = ((tmp_8_fu_389_p2[0:0] === 1'b1) ? 128'd340282366920938463463374607431768211455 : mask_V_read_reg_532);

assign r_V_fu_369_p2 = (lhs_V_cast_fu_365_p1 + 33'd128);

assign raw_berr_int_V_fu_443_p2 = (p_4_reg_290 + p_s_reg_213);

assign raw_blerr_int_V_fu_481_p2 = (t_V_1_reg_226 + 32'd1);

assign rerr_cnt_V_fu_432_p2 = (rerr_cnt_V_trunc_ext_fu_428_p1 + p_4_reg_290);

assign rerr_cnt_V_trunc_ext_fu_428_p1 = grp_num_diff_fu_333_ap_return;

assign src_bits_V_fu_400_p2 = (src_data_V_V_0_data_out & r_V_4_fu_393_p3);
...
assign t_V_2_fu_487_p3 = ((tmp_3_fu_475_p2[0:0] === 1'b1) ? t_V_1_reg_226 : raw_blerr_int_V_fu_481_p2);

assign tmp_1_fu_360_p2 = ((ap_phi_mux_j_V_phi_fu_306_p4 < k_V_read_reg_542) ? 1'b1 : 1'b0);

assign tmp_2_fu_455_p2 = ((p_3_reg_278 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_3_fu_475_p2 = ((p_4_reg_290 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_7_cast_fu_341_p1 = k_V_read_reg_542;

assign tmp_8_fu_389_p2 = ((r_V_reg_570 < tmp_7_cast_reg_548) ? 1'b1 : 1'b0);

assign tmp_9_fu_438_p2 = ((j_reg_314 < n_V_read_reg_537) ? 1'b1 : 1'b0);

assign tmp_s_fu_344_p2 = ((src_inc_parity_V_rea_reg_521 == 32'd0) ? 1'b1 : 1'b0);
