...
always @(posedge clk) begin
    if (rst)
        int_enc_keep_V[15:0] <= 0;
    else if (w_hs && waddr == ADDR_ENC_KEEP_V_DATA_0)
        int_enc_keep_V[15:0] <= (WDATA[31:0] & wmask) | (int_enc_keep_V[15:0] & ~wmask);
end
