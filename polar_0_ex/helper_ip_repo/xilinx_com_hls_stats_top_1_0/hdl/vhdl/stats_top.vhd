...
architecture behav of stats_top is 
    ...
    "stats_top,hls_ip_2018_1_0,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2L-e,HLS_INPUT_CLOCK=2.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.152500,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=16,HLS_SYN_DSP=0,HLS_SYN_FF=3700,HLS_SYN_LUT=3610}";
    ...
    constant ap_ST_fsm_state12 : STD_LOGIC_VECTOR (8 downto 0) := "000010000";
    constant ap_ST_fsm_state13 : STD_LOGIC_VECTOR (8 downto 0) := "000100000";
    ...
    signal src_inc_parity_V_rea_reg_521 : STD_LOGIC_VECTOR (31 downto 0);
    signal num_blocks_V_read_reg_526 : STD_LOGIC_VECTOR (31 downto 0);
    signal mask_V_read_reg_532 : STD_LOGIC_VECTOR (127 downto 0);
    signal n_V_read_reg_537 : STD_LOGIC_VECTOR (31 downto 0);
    signal k_V_read_reg_542 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal block_cnt_int_V_fu_354_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_1_reg_566_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal r_V_fu_369_p2 : STD_LOGIC_VECTOR (32 downto 0);
    signal r_V_reg_570 : STD_LOGIC_VECTOR (32 downto 0);
    signal i_V_fu_375_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_V_reg_575 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal src_bits_V_fu_400_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal src_bits_V_reg_580 : STD_LOGIC_VECTOR (127 downto 0);
    signal hard_bits_V_fu_406_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal hard_bits_V_reg_586 : STD_LOGIC_VECTOR (127 downto 0);
    signal error_bits_V_fu_412_p2 : STD_LOGIC_VECTOR (127 downto 0);
    signal error_bits_V_reg_591 : STD_LOGIC_VECTOR (127 downto 0);
    signal err_cnt_V_fu_422_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter7 : STD_LOGIC := '0';
    signal rerr_cnt_V_fu_432_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal raw_berr_int_V_fu_443_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal raw_berr_int_V_reg_609 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state13 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state13 : signal is "none";
    signal tmp_9_fu_438_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cor_berr_int_V_fu_449_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal cor_berr_int_V_reg_614 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_0243_0_s_fu_467_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_0243_0_s_reg_619 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_V_2_fu_487_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal t_V_2_reg_624 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_V_1_fu_495_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state15 : BOOLEAN;
    signal iter_cnt_int_V_fu_515_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal lhs_V_cast_fu_365_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal tmp_8_fu_389_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal r_V_4_fu_393_p3 : STD_LOGIC_VECTOR (127 downto 0);
    signal err_cnt_V_trunc_ext_fu_418_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal rerr_cnt_V_trunc_ext_fu_428_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_455_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal cor_blerr_int_V_fu_461_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_475_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal raw_blerr_int_V_fu_481_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_s_fu_501_p4 : STD_LOGIC_VECTOR (5 downto 0);
    signal p_Result_2_fu_511_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    port map (
        ...
        block_cnt_V => num_blocks_V_read_reg_526,
        clk => ap_clk,
    ...
    port map (
        ...
        in1_V => src_bits_V_reg_580,
        in2_V => hard_bits_V_reg_586,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state4) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((exitcond_fu_349_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((tmp_s_reg_553 = ap_const_lv1_0) and (src_data_V_V_0_vld_out = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state15))) then 
                j_reg_314 <= j_V_1_fu_495_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((fe_status_V_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then 
                p_1_reg_239 <= cor_berr_int_V_reg_614;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((fe_status_V_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then 
                p_2_reg_265 <= iter_cnt_int_V_fu_515_p2;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_reg_566_pp0_iter6_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter7 = ap_const_logic_1))) then 
                p_3_reg_278 <= err_cnt_V_fu_422_p2;
            elsif (((exitcond_fu_349_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_reg_566_pp0_iter6_reg = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter7 = ap_const_logic_1))) then 
                p_4_reg_290 <= rerr_cnt_V_fu_432_p2;
            elsif (((exitcond_fu_349_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((fe_status_V_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then 
                p_s_reg_213 <= raw_berr_int_V_reg_609;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((fe_status_V_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then 
                t_V_reg_252 <= p_0243_0_s_reg_619;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                block_cnt_int_V_reg_561 <= block_cnt_int_V_fu_354_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_9_fu_438_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state13))) then
                cor_berr_int_V_reg_614 <= cor_berr_int_V_fu_449_p2;
                p_0243_0_s_reg_619 <= p_0243_0_s_fu_467_p3;
                raw_berr_int_V_reg_609 <= raw_berr_int_V_fu_443_p2;
                t_V_2_reg_624 <= t_V_2_fu_487_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_reg_566 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                error_bits_V_reg_591 <= error_bits_V_fu_412_p2;
                hard_bits_V_reg_586 <= hard_bits_V_fu_406_p2;
                src_bits_V_reg_580 <= src_bits_V_fu_400_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_360_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                i_V_reg_575 <= i_V_fu_375_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                k_V_read_reg_542 <= k_V;
                mask_V_read_reg_532 <= mask_V;
                n_V_read_reg_537 <= n_V;
                num_blocks_V_read_reg_526 <= num_blocks_V;
                src_inc_parity_V_rea_reg_521 <= src_inc_parity_V;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_360_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                r_V_reg_570 <= r_V_fu_369_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                tmp_1_reg_566_pp0_iter6_reg <= tmp_1_reg_566_pp0_iter5_reg;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ...
                tmp_s_reg_553 <= tmp_s_fu_344_p2;
            end if;
        end if;
    end process;
    tmp_7_cast_reg_548(32) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, src_data_V_V_0_vld_out, error_data_V_data_V_0_vld_out, fe_status_V_V_0_vld_out, ap_enable_reg_pp0_iter1, ap_CS_fsm_state15, tmp_s_reg_553, ap_CS_fsm_state14, ap_CS_fsm_state16, exitcond_fu_349_p2, ap_CS_fsm_state3, tmp_1_fu_360_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter7, ap_CS_fsm_state13, tmp_9_fu_438_p2, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter6)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state14 => 
                if (((error_data_V_data_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then
                    ap_NS_fsm <= ap_ST_fsm_state15;
                else
                    ap_NS_fsm <= ap_ST_fsm_state14;
                end if;
            when ap_ST_fsm_state15 => 
                if ((not(((tmp_s_reg_553 = ap_const_lv1_0) and (src_data_V_V_0_vld_out = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state15))) then
                    ap_NS_fsm <= ap_ST_fsm_state13;
                else
                    ap_NS_fsm <= ap_ST_fsm_state15;
                end if;
    ...
    ap_block_state15_assign_proc : process(src_data_V_V_0_vld_out, tmp_s_reg_553)
    begin
                ap_block_state15 <= ((tmp_s_reg_553 = ap_const_lv1_0) and (src_data_V_V_0_vld_out = ap_const_logic_0));
    end process;

        ap_block_state4_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state5_pp0_stage0_iter1_assign_proc : process(src_data_V_V_0_vld_out, hard_data_V_data_V_0_vld_out, error_data_V_data_V_0_vld_out, tmp_1_reg_566)
    begin
                ap_block_state5_pp0_stage0_iter1 <= (((tmp_1_reg_566 = ap_const_lv1_1) and (error_data_V_data_V_0_vld_out = ap_const_logic_0)) or ((tmp_1_reg_566 = ap_const_lv1_1) and (src_data_V_V_0_vld_out = ap_const_logic_0)) or ((tmp_1_reg_566 = ap_const_lv1_1) and (hard_data_V_data_V_0_vld_out = ap_const_logic_0)));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state4_assign_proc : process(tmp_1_fu_360_p2)
    begin
        if ((tmp_1_fu_360_p2 = ap_const_lv1_0)) then 
    ...
    ap_done_assign_proc : process(exitcond_fu_349_p2, ap_CS_fsm_state3)
    begin
        if (((exitcond_fu_349_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_idle_pp0_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter7, ap_enable_reg_pp0_iter2, ap_enable_reg_pp0_iter3, ap_enable_reg_pp0_iter4, ap_enable_reg_pp0_iter5, ap_enable_reg_pp0_iter6)
    begin
    ...
    ap_ready_assign_proc : process(exitcond_fu_349_p2, ap_CS_fsm_state3)
    begin
        if (((exitcond_fu_349_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    block_cnt_int_V_fu_354_p2 <= std_logic_vector(unsigned(t_V_3_reg_202) + unsigned(ap_const_lv32_1));
    cor_berr_int_V_fu_449_p2 <= std_logic_vector(unsigned(p_3_reg_278) + unsigned(p_1_reg_239));
    cor_blerr_int_V_fu_461_p2 <= std_logic_vector(unsigned(t_V_reg_252) + unsigned(ap_const_lv32_1));
    err_cnt_V_fu_422_p2 <= std_logic_vector(unsigned(err_cnt_V_trunc_ext_fu_418_p1) + unsigned(p_3_reg_278));
    err_cnt_V_trunc_ext_fu_418_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_num_diff_fu_325_ap_return),32));
    error_bits_V_fu_412_p2 <= (r_V_4_fu_393_p3 and error_data_V_data_V_0_data_out);

    error_data_TDATA_blk_n_assign_proc : process(error_data_V_data_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_1_reg_566, ap_CS_fsm_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state14) or ((tmp_1_reg_566 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    error_data_V_data_V_0_ack_out_assign_proc : process(error_data_V_data_V_0_vld_out, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_1_reg_566, ap_CS_fsm_state14, ap_block_pp0_stage0_11001)
    begin
        if ((((error_data_V_data_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14)) or ((tmp_1_reg_566 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    error_data_V_last_V_0_ack_out_assign_proc : process(error_data_V_data_V_0_vld_out, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_1_reg_566, ap_CS_fsm_state14, ap_block_pp0_stage0_11001)
    begin
        if ((((error_data_V_data_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14)) or ((tmp_1_reg_566 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    exitcond_fu_349_p2 <= "1" when (t_V_3_reg_202 = num_blocks_V_read_reg_526) else "0";
    fe_status_V_V_0_ack_in <= fe_status_V_V_0_state(1);

    fe_status_V_V_0_ack_out_assign_proc : process(fe_status_V_V_0_vld_out, ap_CS_fsm_state16)
    begin
        if (((fe_status_V_V_0_vld_out = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then 
    ...
    fe_status_V_V_TDATA_blk_n_assign_proc : process(fe_status_V_V_0_state, ap_CS_fsm_state16)
    begin
    ...
    hard_bits_V_fu_406_p2 <= (r_V_4_fu_393_p3 and hard_data_V_data_V_0_data_out);
    ...
    i_V_fu_375_p2 <= std_logic_vector(unsigned(ap_phi_mux_j_V_phi_fu_306_p4) + unsigned(ap_const_lv32_80));
    iter_cnt_int_V_fu_515_p2 <= std_logic_vector(unsigned(p_Result_2_fu_511_p1) + unsigned(p_2_reg_265));
    j_V_1_fu_495_p2 <= std_logic_vector(unsigned(j_reg_314) + unsigned(ap_const_lv32_80));
    lhs_V_cast_fu_365_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_phi_mux_j_V_phi_fu_306_p4),33));
    p_0243_0_s_fu_467_p3 <= 
        t_V_reg_252 when (tmp_2_fu_455_p2(0) = '1') else 
        cor_blerr_int_V_fu_461_p2;
    p_Result_2_fu_511_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Result_s_fu_501_p4),32));
    p_Result_s_fu_501_p4 <= fe_status_V_V_0_data_out(23 downto 18);
    r_V_4_fu_393_p3 <= 
        ap_const_lv128_lc_1 when (tmp_8_fu_389_p2(0) = '1') else 
        mask_V_read_reg_532;
    r_V_fu_369_p2 <= std_logic_vector(unsigned(lhs_V_cast_fu_365_p1) + unsigned(ap_const_lv33_80));
    raw_berr_int_V_fu_443_p2 <= std_logic_vector(unsigned(p_4_reg_290) + unsigned(p_s_reg_213));
    raw_blerr_int_V_fu_481_p2 <= std_logic_vector(unsigned(t_V_1_reg_226) + unsigned(ap_const_lv32_1));
    rerr_cnt_V_fu_432_p2 <= std_logic_vector(unsigned(rerr_cnt_V_trunc_ext_fu_428_p1) + unsigned(p_4_reg_290));
    rerr_cnt_V_trunc_ext_fu_428_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_num_diff_fu_333_ap_return),32));
    src_bits_V_fu_400_p2 <= (src_data_V_V_0_data_out and r_V_4_fu_393_p3);
    src_data_V_V_0_ack_in <= src_data_V_V_0_state(1);

    src_data_V_V_0_ack_out_assign_proc : process(src_data_V_V_0_vld_out, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_1_reg_566, ap_CS_fsm_state15, tmp_s_reg_553, ap_block_pp0_stage0_11001)
    begin
        if (((not(((tmp_s_reg_553 = ap_const_lv1_0) and (src_data_V_V_0_vld_out = ap_const_logic_0))) and (tmp_s_reg_553 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state15)) or ((tmp_1_reg_566 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    src_data_V_V_TDATA_blk_n_assign_proc : process(src_data_V_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_1_reg_566, ap_CS_fsm_state15, tmp_s_reg_553)
    begin
        if ((((tmp_s_reg_553 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state15)) or ((tmp_1_reg_566 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    t_V_2_fu_487_p3 <= 
        t_V_1_reg_226 when (tmp_3_fu_475_p2(0) = '1') else 
        raw_blerr_int_V_fu_481_p2;
    tmp_1_fu_360_p2 <= "1" when (unsigned(ap_phi_mux_j_V_phi_fu_306_p4) < unsigned(k_V_read_reg_542)) else "0";
    tmp_2_fu_455_p2 <= "1" when (p_3_reg_278 = ap_const_lv32_0) else "0";
    tmp_3_fu_475_p2 <= "1" when (p_4_reg_290 = ap_const_lv32_0) else "0";
    tmp_7_cast_fu_341_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_V_read_reg_542),33));
    tmp_8_fu_389_p2 <= "1" when (unsigned(r_V_reg_570) < unsigned(tmp_7_cast_reg_548)) else "0";
    tmp_9_fu_438_p2 <= "1" when (unsigned(j_reg_314) < unsigned(n_V_read_reg_537)) else "0";
    tmp_s_fu_344_p2 <= "1" when (src_inc_parity_V_rea_reg_521 = ap_const_lv32_0) else "0";
end behav;
