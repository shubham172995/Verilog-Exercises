...
HD_PWD='/home/shubham/Vivado_Exercises/first_zynq_design/first_zynq_design.runs/first_zynq_system_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_zynq_system_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_zynq_system_rst_ps8_0_99M_0.tcl
