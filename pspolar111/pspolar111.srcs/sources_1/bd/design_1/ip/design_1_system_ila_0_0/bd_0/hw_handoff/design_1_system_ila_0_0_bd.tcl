...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXIS:SLOT_3_AXIS:SLOT_4_AXIS:SLOT_5_AXI} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_5_AXI_ADDR_WIDTH {18} \
...
connect_bd_intf_net -intf_net Conn5 [get_bd_intf_ports SLOT_5_AXI] [get_bd_intf_pins g_inst/slot_5_axi]
  ...
  connect_bd_net -net net_slot_5_axi_ar_cnt [get_bd_pins g_inst/m_slot_5_axi_ar_cnt] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net net_slot_5_axi_ar_ctrl [get_bd_pins ila_lib/probe32] [get_bd_pins slot_5_ar/dout]
  connect_bd_net -net net_slot_5_axi_araddr [get_bd_pins g_inst/m_slot_5_axi_araddr] [get_bd_pins ila_lib/probe22]
  ...
  connect_bd_net -net net_slot_5_axi_aw_cnt [get_bd_pins g_inst/m_slot_5_axi_aw_cnt] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net net_slot_5_axi_aw_ctrl [get_bd_pins ila_lib/probe29] [get_bd_pins slot_5_aw/dout]
  connect_bd_net -net net_slot_5_axi_awaddr [get_bd_pins g_inst/m_slot_5_axi_awaddr] [get_bd_pins ila_lib/probe24]
  ...
  connect_bd_net -net net_slot_5_axi_b_cnt [get_bd_pins g_inst/m_slot_5_axi_b_cnt] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_5_axi_b_ctrl [get_bd_pins ila_lib/probe31] [get_bd_pins slot_5_b/dout]
  ...
  connect_bd_net -net net_slot_5_axi_r_cnt [get_bd_pins g_inst/m_slot_5_axi_r_cnt] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net net_slot_5_axi_r_ctrl [get_bd_pins ila_lib/probe33] [get_bd_pins slot_5_r/dout]
  connect_bd_net -net net_slot_5_axi_rdata [get_bd_pins g_inst/m_slot_5_axi_rdata] [get_bd_pins ila_lib/probe27]
  ...
  connect_bd_net -net net_slot_5_axi_w_ctrl [get_bd_pins ila_lib/probe30] [get_bd_pins slot_5_w/dout]
  connect_bd_net -net net_slot_5_axi_wdata [get_bd_pins g_inst/m_slot_5_axi_wdata] [get_bd_pins ila_lib/probe28]
