...
proc create_root_design { parentCell } {
  ...
  # Create instance: datagdec_0, and set properties
  set datagdec_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:datagdec:1.0 datagdec_0 ]
  ...
  connect_bd_intf_net -intf_net datagdec_0_control_V [get_bd_intf_pins datagdec_0/control_V] [get_bd_intf_pins polar_0/S_AXIS_CTRL]
connect_bd_intf_net -intf_net [get_bd_intf_nets datagdec_0_control_V] [get_bd_intf_pins polar_0/S_AXIS_CTRL] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  connect_bd_intf_net -intf_net datagdec_0_din [get_bd_intf_pins datagdec_0/din] [get_bd_intf_pins polar_0/S_AXIS_DIN]
connect_bd_intf_net -intf_net [get_bd_intf_nets datagdec_0_din] [get_bd_intf_pins polar_0/S_AXIS_DIN] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  connect_bd_intf_net -intf_net datagdec_0_din_words [get_bd_intf_pins datagdec_0/din_words] [get_bd_intf_pins polar_0/S_AXIS_DIN_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets datagdec_0_din_words] [get_bd_intf_pins polar_0/S_AXIS_DIN_WORDS] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net datagdec_0_dout_words [get_bd_intf_pins datagdec_0/dout_words] [get_bd_intf_pins polar_0/S_AXIS_DOUT_WORDS]
connect_bd_intf_net -intf_net [get_bd_intf_nets datagdec_0_dout_words] [get_bd_intf_pins polar_0/S_AXIS_DOUT_WORDS] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
connect_bd_intf_net -intf_net polar_0_M_AXIS_DOUT [get_bd_intf_pins polar_0/M_AXIS_DOUT] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net polar_0_M_AXIS_STATUS [get_bd_intf_pins polar_0/M_AXIS_STATUS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins polar_0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD1 [get_bd_intf_pins ps8_0_axi_periph/S02_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net polar_0_interrupt [get_bd_pins polar_0/interrupt] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins datagdec_0/ap_rst_n] [get_bd_pins polar_0/reset_n] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins ps8_0_axi_periph/S02_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins datagdec_0/ap_start] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins polar_0/m_axis_dout_tready] [get_bd_pins polar_0/m_axis_status_tready] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins datagdec_0/ap_clk] [get_bd_pins polar_0/core_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins ps8_0_axi_periph/S02_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00040000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs polar_0/S_AXI/PARAMS] SEG_polar_0_PARAMS
