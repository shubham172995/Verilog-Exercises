...
HD_PWD='/home/shubham/Vivado_Exercises/decPolarPS/decPolarPS.runs/design_1_datagdec_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_datagdec_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_datagdec_0_0.tcl
