...
HD_PWD='/home/shubham/Vivado_Exercises/project_7/project_7.runs/design_1_system_ila_1_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_system_ila_1_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_system_ila_1_3.tcl
