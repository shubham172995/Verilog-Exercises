...
HD_PWD='/home/shubham/Vivado_Exercises/zynq_interrupts/zynq_interrupts.runs/zynq_interrupt_system_rst_ps8_0_99M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_rst_ps8_0_99M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_rst_ps8_0_99M_1.tcl
