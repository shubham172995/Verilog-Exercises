...
ISEStep( "vivado",
         "-log zynq_interrupt_system_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_zynq_ultra_ps_e_0_0.tcl" );
